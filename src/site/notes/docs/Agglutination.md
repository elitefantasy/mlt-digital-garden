...
2. Principle of agglutination	  
   3. Sensitization  
   4. Lattice formation  
   5. Factors influencing reaction strength  
6. Grading system of aglutination reaction   
   7. Common grading system are  
      1. Tube  
         1. Principle  
         2. Grading table  
      2. Gel methods  
...
The antigens involved are usually large, easily sedimented particles such as red blood cells, bacteria, or latex beads; the antibodies that cause clumping are called agglutinins.

Clinically, agglutination reactions are used in tests like blood group typing, Widal test, RA factor, latex tests, Coombs tests, and many rapid immunoassays, because the visible clumps can be read by the naked eye or simple instruments.  
...
1. Sensitization (antibody binding to antigen surface)  
2. Lattice formation (cross‑linking into a three‑dimensional network)
...
* Sensitization is influenced by:  
  * **pH**: Most IgG and IgM antibodies bind optimally near physiological pH (around 7.0–7.4).  
  * **Temperature**: IgM usually reacts best at lower temperatures (4–22 °C), whereas IgG requires around 37 °C.  
  * **Incubation time**: Typically 15–60 minutes, depending on the test protocol.
...
* Antigen (cells, bacteria, or latex particles) is added to serial dilutions of patient serum or reagent antibody in the tube.  
...
| Grade | Description |
| :---: | ----- |
| 0 (Negative) | No visible clumps. Supernatant: dark/turbid (all cells remain in suspension). |
| Weak / ± | Tiny agglutinates visible only microscopically or as very fine granularity. Supernatant: dark, turbid. |
| 1+ | Many small agglutinates; background may still appear slightly turbid. Supernatant: turbid. |
| 2+ | Medium-sized clumps; fewer free cells. Supernatant: clearer, less turbid. |
| 3+ | Many large agglutinates; minimal free cells. Supernatant: clear. |
| 4+ | One large solid clump or a few very large clumps; almost no free cells. Supernatant: clear. |
...
* Red cells or other particles are mixed with antibodies, then the mixture is **placed on top of a gel column** and centrifuged.  
* **Non‑agglutinated cells** migrate to the bottom of the gel, forming a pellet.  
* **Agglutinated cells** (large complexes) are **trapped within or at the top of the gel** because they cannot pass through the pores.
...
| Grade | Description |
| :---: | ----- |
| 0 (Negative) | Compact cell button at the bottom of the gel column. No cells in the gel; indicates no agglutination. |
| 1+ | Most cells at the bottom, with a few small aggregates dispersed in the lower part of the gel. |
| 2+ | Cells distributed mainly in the lower half of the gel column, with some at the bottom. |
| 3+ | Cells distributed throughout the gel column; few or none at the bottom. |
| 4+ | All cells remain at the top of the gel column, forming a distinct band; no cells migrate into or through the gel. |
