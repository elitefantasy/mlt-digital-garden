...
# Intro
**Largest Parasites**
- **Whale Tapeworm:** Reaches up to 30+ meters, living inside large marine mammals.
- **Fish Tapeworm (*Diphyllobothrium latum*):** The largest human tapeworm, growing up to 10–15 meters (30–50 feet) long in the intestine.
- **Beef Tapeworm (*Taenia saginata*):** Can reach lengths up to 25 meters.

**Smallest Parasites**
- **Protozoan Parasites:** Microscopic organisms such as *Plasmodium* and *Leishmania* measure approximately 1–5 micrometers and live inside individual blood or tissue cells.
- **Viruses:** Obligate intracellular parasites such as influenza or common cold viruses are even smaller and are measured in nanometers.
- **Trichinella spiralis:** The smallest nematode parasite of humans, with adults measuring approximately 1.4–1.6 mm.

## Types of Parasites

1. **Ectoparasite:** Parasites that live on the external surface of the host.
   - Examples: Lice, fleas, ticks, mites.

2. **Endoparasite:** Parasites that live inside the body of the host.
   - Examples: *Entamoeba histolytica*, *Ascaris lumbricoides*.

3. **Obligate Parasite:** Must live inside a host to complete its life cycle and cannot live freely in the environment.
   - Examples: *Plasmodium*, *Taenia solium*, *Toxoplasma gondii*.

4. **Facultative Parasite:** Normally lives freely in the environment but can become parasitic when it enters a host.
   - Example: *Naegleria fowleri*.

5. **Permanent Parasite:** Remains in or on the host for most or all of its life cycle.
   - Examples: *Ascaris lumbricoides*, *Taenia saginata*.

6. **Temporary Parasite:** Visits the host only for feeding.
   - Examples: Mosquitoes, bed bugs.

7. **Accidental Parasite:** Infects an unusual host in which it does not normally live.
   - Example: *Echinococcus granulosus*.

8. **Opportunistic Parasite:** Causes disease mainly in immunocompromised individuals.
   - Examples: *Cryptosporidium parvum*, *Toxoplasma gondii*.

9. **Free-Living Parasite:** Can survive independently of a host.
   - Example: Cystic form of *Naegleria fowleri*.

## Types of Hosts

1. **Definitive Host:** The parasite reaches sexual maturity inside the host. The adult stage is present and sexual reproduction occurs.
   - Examples:
     - *Taenia saginata* → Humans
     - Female mosquito → *Plasmodium*

2. **Intermediate Host:** The larval or asexual stage of the parasite develops inside the host. One or two intermediate hosts may be required.
   - Example: Cow for *Taenia saginata*.

3. **Reservoir Host:** An animal host that harbors a parasite and acts as a natural source of infection for humans.
   - Example: Dogs as reservoir hosts of *Leishmania*.

4. **Paratenic Host:** The parasite does not undergo development but remains alive and infective until it reaches the definitive host. It helps transmit the infection to another host.
   - Example: Fish for the plerocercoid larva of *Diphyllobothrium latum*.

5. **Accidental Host:** A host that is not normally part of the parasite's life cycle but becomes infected accidentally. The parasite cannot complete its life cycle inside the host.
   - Example: Humans infected with *Echinococcus granulosus* causing hydatid disease.
...
2. **Mutualism**
   - By definition, a parasite cannot be mutualistic.
...
| --------------------- | --------------------------- |
| Entamoeba histolytica | ==1;;Mature cyst==          |
| Giardia duodenalis    | ==1;;Cyst==                 |
| Ascaris lumbricoides  | ==1;;Embryonated egg==      |
| Trichrome trichiura   | ==1;;Embryonated egg==      |
| Taenia solium         | ==1;;Egg -> cysticercosis== |
...
- Raw crab/crayfish - Paragonimus westermani
	- Infective staae: Metacercaria
...
The parasite actively penetrates intact skin. This is extremely important in helminthology.

1. Hookworms
	- Ancylostoma duodenale
	- Necator americanus
	- Infective stage: Filariform L3 larva
	- Route: Skin penetration
	- Source: Contaminated soil
- 2. Strongyloides stercoralis
	- Infective stage: Filariform larva
	- Enters through skin
	- Then migrates through bloodstream > lungs -- swallowed - intestine 
- 3. schistosoma 
	- Infective stage: Cercaria
	- Cercaria penetrates human skin in contaminated freshwater.
...
- Schizogamy — multiple fission.

**Sexual Reproduction**
- Conjugation
- Syngamy — seen in *Plasmodium*.

**Life Cycle**
- **Trophozoite:** Vegetative stage; motile, feeding, and sensitive to environmental changes.
- **Cyst:** Protective stage; has a thick wall, is non-motile, and is the infective stage for humans.
...
| Feature                              | _Entamoeba histolytica_                                                                                      | _Giardia lamblia_                                                                                                | _Balantidium coli_                                                                                                        |
| :----------------------------------- | :----------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------ |
| **Taxonomic Group**                  | **Amoeba** (Amoeboid)                                                                                        | **Flagellate**                                                                                                   | **Ciliate** (Phylum _Ciliophora_)                                                                                         |
| **Exam Landmark / Status**           | Primary agent of **amoebic dysentery** & liver abscess                                                       | Leading cause of **traveler's diarrhea**                                                                         | **Largest protozoan parasite** of humans & **only pathogenic ciliate**                                                    |
| **Primary Habitat in Host**          | **Large intestine** (cecum and colon)                                                                        | **Small intestine** (duodenum and upper jejunum)                                                                 | **Large intestine** (colon of humans, pigs, monkeys)                                                                      |
| **Infective Form & Transmission**    | **Mature quadrinucleate cyst** via **fecal-oral route** (contaminated food/water)                            | **Mature quadrinucleate cyst** via **fecal-oral route** (ingestion of as few as 10 cysts)                        | **Cyst** via **fecal-oral route** (zoonotic transmission from pig feces)                                                  |
| **Trophozoite Shape & Motility**     | Irregularly shaped; active, **unidirectional crawling motility** via pseudopodia                             | **Pear / Tennis-racket shaped**; bilaterally symmetrical; **falling-leaf motility**                              | Large ovoid cell (60–70 µm); covered in **short cilia**; rapid revolving motility                                         |
| **Trophozoite Nucleus & Structures** | **Single nucleus** with central dot-like karyosome ("cartwheel" look); cytoplasm has **ingested RBCs**       | **2 nuclei** (**"face-like" / "monkey-face"** look); **4 pairs of flagella** (8 total); **ventral sucking disc** | **2 nuclei**: 1 large kidney-shaped **macronucleus** + 1 small **micronucleus**; cytostome (mouth) & cytopyge (anal pore) |
| **Cyst Morphology**                  | Spherical; **1 to 4 nuclei**; **cigar-shaped chromatoid bodies** (rounded ends) & glycogen mass              | Oval (8–12 µm); **2 to 4 nuclei** clustered at one end; contains S-shaped axonemes/fibrils                       | Spherical (40–60 µm); thick double-layered wall; contains 1 kidney-shaped **macronucleus**                                |
| **Pathology & Lesion**               | Invades tissue producing **flask-shaped ulcers** in the colon                                                | Non-invasive; attaches to duodenal mucosa causing villous blunting & **fat/nutrient malabsorption**              | Burrows into mucosa/submucosa causing **mucosal ulcers & submucosal abscesses**                                           |
| **Clinical Presentation**            | Foul-smelling dysentery (blood & mucus), abdominal cramps; **Amoebic Liver Abscess** ("anchovy sauce" pus)   | **Foul-smelling, pale, greasy/fatty diarrhea** (steatorrhea) that floats in water; flatulence, bloating          | Asymptomatic commensal or frank dysentery with diarrhea, abdominal colic, and tenesmus                                    |
| **Extraintestinal Spread**           | **Yes** (travels via portal blood to **liver**, lungs, or brain)                                             | **No** (confined to intestinal lumen/gallbladder)                                                                | **No** (does **not** invade the liver or extraintestinal sites)                                                           |
...
##### Introduction
 * **Entamoeba histolytica** is a **pathogenic intestinal protozoan parasite** that causes **amoebiasis (amoebic dysentery)**.
##### Morphology & Stages
3 forms
 ...
 * **Staining Properties:**
	* Trichrome stain: Permanent stool staining for cyst and trophozoite morphology.
	* Iron hematoxylin: Nuclei and chromatoid bodies stain dark blue/black; glycogen remains clear.
	* Iodine wet mount: Glycogen turns golden brown, nuclei/karyosome bright yellow, chromatoid bodies remain unstained.
	* PAS (Periodic Acid-Schiff) stain: Demonstrates amoebae in tissue sections.
**Hepatic Abscess Diagnosis**
	* Microscopic examination of aspirated liver pus or edge biopsies for trophozoites.
	* Cysts are found in stool in ~15% of hepatic cases.
	* Imaging (Ultrasound, CT, MRI, X-ray) detects abscesses but cannot differentiate amoebic from pyogenic causes.
**Culture, Serology & Molecular Tests**
	* Culture Media (Polyxenic): Boeck and Drbohlav, Balamuth's, and Jones media.
	* Antigen Detection: ELISA on stool, serum, or aspirates.
	* Antibody Detection: IHA, IFA, and ELISA (IHA \ge 1:256 or IFA \ge 1:200 suggest hepatic amoebiasis).
	* Molecular: PCR and DNA probes for detecting amoebic DNA in feces or aspirated pus.
##### Treatment & Prevention
 * **Tissue & Intestinal Disease**: Metronidazole and Nitroimidazoles.
 * **Luminal Agents:** Diiodohydroxyquin and Diloxanide furoate.
 * **Supportive Care:** Fluid and electrolyte therapy.
...
- Primary Habitat: Human small intestine
- Specific Location: Duodenum and upper jejunum
...
- Symptomatic Cases: Mucus-heavy diarrhea, fat malabsorption, epigastric discomfort, and flatulence. 
- Effects in Children: Chronic diarrhea, nutrient malabsorption, weight loss, and sprue-like syndrome. 
...
- Macroscopic Examination: Stool may have an offensive odor, a pale fatty appearance, and float in water. 
- Microscopic Examination: Uses wet preparations and concentration techniques for detection. 
- Asymptomatic Carriers: Typically show only cysts in stool samples.
...
- **Structure:** 
    ...
    - **Anterior End:** Features a groove (_peristome_) leading to the mouth (_cytostome_) and a short funnel-shaped gullet (_cytopharynx_).
    - **Posterior End:** Has a small anal pore (_cytopyge_).
    - **Adoral Cilia:** Cilia surrounding the mouth are larger.
- **Nuclear Apparatus (Two Nuclei):**
...
- **Host Requirement:** Completes its life cycle in **one host only** (single-host life cycle).
    ...
    - **Infective Form:** Cyst
- **Transmission:** Balantidiasis is a zoonosis. Humans acquire infection by ingesting food or water contaminated with feces containing cysts from pigs, animal reservoirs, or human carriers.
- **Excystation:** Occurs in the small intestine following cyst ingestion.
- **Development & Colonization:**
    - From each cyst, a **single trophozoite** is liberated, which migrates to the large intestine.
    - Trophozoites multiply in the large intestine by **transverse binary fission**.
    - Sexual reproduction occurs infrequently by **conjugation**, during which reciprocal exchange of nuclear material happens between two trophozoites enclosed within a single cyst wall.
- **Encystation:**
    - Occurs as trophozoites pass down the colon or in evacuated stool.
    - The cell rounds up and secretes a tough cyst wall.
    - Cysts remain viable in feces for **1 to 2 days** to contaminate food/water and spread to new hosts.
##### 4. Pathogenesis & Clinical Feature
- **Commensal Phase:** In healthy individuals, _B. coli_ lives as a lumen commensal and remains asymptomatic.
- **Predisposing Factors:** Disease develops when host resistance is lowered by:
    - Malnourishment
    - Alcoholism
    - Achlorhydria (absence of stomach acid)
    - Concurrent infection by _Trichuris trichiura_ or bacterial infections
- **Pathology:**
    - Trophozoites burrow into the intestinal mucosa, establish colonies, and cause an inflammatory reaction.
    - Forms **mucosal ulcers** and **submucosal abscesses** (resembling lesions in amebiasis).
    - **Key Distinction:** Unlike _Entamoeba histolytica_, _B. coli_ **does not** invade the liver or any other extraintestinal sites.
- **Clinical Features:**
...
- **Stool Examination:**
    ...
    - **Diarrheic Feces:** Motile trophozoites (recognized by large size, kidney-shaped macronucleus, and rapid-revolving motility).
    - **Formed Stool:** Cysts (recognized by round shape and large macronucleus).
- **Biopsy:** Biopsy specimens and scrapings from intestinal ulcers can be examined if stool tests are negative.
- **Culture:** Can be cultured in vitro in Locke's egg albumin medium or IH polygenic medium (similar to _E. histolytica_), though rarely necessary.
...
- Symptoms
	- diarhea
- Species: C.hominis and c parvum
...
- oocyst undergoes sporogony to form sporulated oocyst which contains 4 sporozoites
- sporulated oocyst released into feces

**Pathogenecity and clinical features**
- incubation period : 2-14 days
- non immunocompromised -> asymptomatic
- travelers diarrhea 
- immunocompromised: diarhea , emaciation, 

other parasite that cause traveler's diarrhea : cryptosporidum parvum , entamoeba histolytica , giardia lambia , cyclospora cayetanensis

**Lab diagnosis**
- oocyst in feces
- wet mount: oocyst containing large and small granules
- modified zn stain
- floatation or sedimentation techniques
...
- Digestive system:
	- Complete in roundworms.
	- Incomplete in flukes.
	- Absent in tapeworms.

**Reproduction**
1. **Dioecious:** Separate male and female sexes.
   - Example: Nematodes.
1. **Monoecious:** Male and female reproductive organs occur in the same organism.
   - Examples: Cestodes and trematodes.

### 2.1 Nematodes (Roundworms)
Cylindrical, unsegmented worms with a complete digestive tract.

- **Intestinal:**
	- [[docs/Parasitology Examples#**A. _Ascaris lumbricoides_ (Giant Roundworm)**\| Ascaris lumbricoides]]
- **Tissue:**
...
4 types of flukes
1. blood flukes  [[docs/Parasitology Examples#**A. Schistosomes (Blood Flukes)**\|Schistosomes]]
	1. Schistosomea haematobium
	2. schistosma mansoni
	3. schistosoma japonicum
2.  [[docs/Parasitology Examples#B. Hermaphroditic Flukes\|Hermaphroditic Flukes]]
...
Tape-like and segmented worms.

**2.3.1 Pseudophyllidea**
- [[docs/Parasitology Examples#Diphyllobothrium latum\|Diphyllobothrium DLatum]] / Fish tapeworm

**2.3.2 Cyclophyllidea**
- *hymenolepis nana*
- [[docs/Parasitology Examples#Echinococcus granulosa\|Echinococcus Granulosa]]
	- Common name: Dog tapeworm
	- Causes hydatid disease.
- *Dipylidium caninum*
	- Also known as flea tapeworm or cucumber tapeworm.
- *Taenia* species:
...
- Can act as parasites or vectors of parasites.

### Role in Disease
- **Mechanical Vector:** Carries microorganisms, such as bacteria, on its legs or body.
- **Biological Vector:** Parasite completes part of its life cycle inside the arthropod.
