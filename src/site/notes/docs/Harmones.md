...
![Pasted image 20260827083253.png\|312](/img/user/Attachments/Pasted%20image%2020260827083253.png)
...
flowchart TD
    ...
    OS --> ZG["Zona Glomerulosa"]
    OS --> ZF["Zona Fasciculata"]
    OS --> ZR["Zona Reticularis"]

    ZG --> M["Mineralocorticoids (mainly Aldosterone) [Salt]"]
    ZF --> G["Glucocorticoids (mainly Cortisol) [Sugar]"]
    ZR --> S["Sex Corticoids (mainly Androgens) [Sex]"]
```
