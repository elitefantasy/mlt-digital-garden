---
{"dg-publish":true,"permalink":"/docs/dna-specific-virus/","tags":["flashcards"],"dg-note-properties":{"Subject":["Microbiology"],"tags":["flashcards"]}}
---
...
## I. Classification & Morphology
*   **Family:** Belongs to the *Herpesviridae* family 
*   **Nucleic Acid:** It is a Double-Stranded DNA (dsDNA) virus
*   **Structure:** Herpes is an enveloped virus 
*   **Symmetry:** Exhibits Icosahedral symmetry 

## II. Medically Important Members of the Family**
The *Herpesviridae* family includes several clinically significant viruses:
?
...
*   **Respiratory Route:** Several herpes viruses (including CMV, EBV, and VZV) can spread via the respiratory route
*   **Cutaneous Route (Skin):** Herpes Simplex Virus (HSV) can be transmitted through direct skin contact 
*   **Sexual Route:** HSV is notably transmitted through sexual contact 
...
*   **Inclusion Bodies:** 
    ...
    *   Specifically, they form acidophilic intranuclear inclusions known as **Cowdry Type A** bodies 
    *   A highly specific type of inclusion body seen in HSV infections is the **Lipschutz body**

## V. Clinical Features & Pathology**
...
**I. Basic Characteristics & Latency**
*   **Viral Nature:** Cytomegalovirus (CMV) is a highly **sensitive virus** 
*   **Latency:** CMV is known for exhibiting **latent infections** 
* This means the virus can remain dormant or inactive inside the host's body for many years (such as 5, 10, or 15 years) without showing symptoms The virus may eventually reactivate and cause infection, often when the host's immune system becomes compromised 
*   **Neurological Impact:** The damage caused by latent viruses like CMV often progresses very slowly and can heavily impact the neurons and the brain 
...
*   **TORCH Infection:** CMV is a major component of the **TORCH complex** of infections, which are known to cause severe **congenital** abnormalities when transmitted from **mother to child** 
*   **Fetal Impact:** If a fetus is infected with CMV in the womb, the newborn can present with various **congenital deformities and jaundice** 

# Simian 40 Virus
#### I. Classification & Viral Nature
*   **Viral Family:** The Simian 40 virus belongs to the **Polyomavirus** group 
*   **Nucleic Acid:** :: Unlike many other common viruses (such as Ebola or Rabies, which are RNA viruses), Simian 40 is a **Double-Stranded (DS) DNA virus**
<!--SR:!2026-09-10,12,270-->

#### II. Genomic Characteristics & Structure
*   **Genome Structure:** It contains **DS circular DNA** 
*   **Nucleosomes:** Its DNA is specifically wrapped up as nucleosomes with the help of **histone proteins** 
*   **Morphology:** The virus exhibits a large, **hexagon-shaped** structure, which is visually somewhat similar to the structure of the Herpes Simplex Virus (HSV) 

#### III. Isolation & Cultivation
*   **Origin:** The virus was first discovered and isolated from a contaminated **monkey kidney culture** 
